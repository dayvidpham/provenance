...
type Tracker interface {
	...
	// specific plan or Unplanned to opt out (roadmap §3.1).
	...
	// ---------------------------------------------------------------------------
	// Plans (P-Plan reification of the Phase enum, roadmap §3.1)
	// ---------------------------------------------------------------------------
	...
	// ---------------------------------------------------------------------------
	// Derivation qualifiers (typed :derivationKind, roadmap §3.3)
	// ---------------------------------------------------------------------------
	//
