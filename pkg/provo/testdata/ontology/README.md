...
conform to (`provo` is the paper's reference implementation).
...
copied **2026-07-23** for provenance milestone M2.

To refresh: re-copy both files from the paper repo's `ontology/` directory and update
