...
var (
	...
	// ErrAgentAlreadyExists is returned when a fixed software-agent activation
	// finds a conflicting agent with the requested identity. Exact activation
	...
	// qualifier (the paper's :derivationKind) can attach only to an existing
