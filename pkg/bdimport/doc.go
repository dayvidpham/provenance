...
// into the provenance model (roadmap §4: beads → provenance → data-labour-prov graph). It is
// the library behind cmd/bd-import; the CLI is a thin shell over Import.
//
// # Header re-survey (mandatory, roadmap §4 design contract)
//
...
//     honest acting agent per roadmap §4), stage derived from status; EdgeGeneratedBy
