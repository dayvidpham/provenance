...
// ---------------------------------------------------------------------------
// Built-in plan identity (reification of the Phase enum, roadmap §3.1)
// ---------------------------------------------------------------------------
...
const (
	...
	// name the roadmap refers to it by ("pasture-12-phase").
	BuiltinPlanTitle = "pasture-12-phase"
	// BuiltinPlanVersion is the version string carried on the seeded built-in
	// plan. Guideline-document plans (the paper's prov:hadPlan) become
...
// built-in plan reifies the Phase enum; guideline documents (the paper's
...
// two tasks (the paper's :derivationKind, attached only via
