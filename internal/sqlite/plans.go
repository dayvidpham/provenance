...
// plans.go implements the plan-layer persistence: the plans /
...
// if it is absent (additive migration). Idempotent: a no-op once the
...
// 13 steps idempotently. INSERT OR IGNORE preserves any existing
